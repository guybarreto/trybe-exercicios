...
// R: Devido à propriedade "transform: translateY(-20px);" inserida na class tech em style.css
...
// a cor do mesmo;
meuTop3.addEventListener('mouseenter', changeColor);
meuTop3.addEventListener('mouseleave', changeColor);

function changeColor(event) {
  event.type === 'mouseenter'
    ? (meuTop3.style.color = 'yellow')
